package com.example.android_final_28;
...
public class MainActivity extends AppCompatActivity {
    ...
    private View.OnClickListener onCustomClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            /**建立要嵌入在通知裡的介面*/
            @SuppressLint("RemoteViewLayout") RemoteViews view = new RemoteViews(getPackageName(),R.layout.custom_notification);
            ...
            /**設置通知內的控件要做的事*/
            /*設置標題*/
            view.setTextViewText(R.id.textView_Title,"你有新訊息");
            /*設置圖片*/
